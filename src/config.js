...
export var style = '.recs-slider{overflow:auto}.recs-slider-heading{display:block}.recs-slider__item{cursor:pointer;float:left;margin-right:5px;margin-left:5px;text-align:center}.recs-slider__item:last-of-type{margin-right:0}.recs-slider__item img{margin-bottom:3px;width:inherit}.recs-slider-container{margin-top:8px;overflow:hidden;width:100%}.unbxd-vertical-recs-slider{width:inherit;position:relative}.recs-vertical-button-container{text-align:left;}.recs-vertical-slider{overflow:hidden}.recs-vertical-slider__item{margin:10px 0}.recs-vertical-slider__item img{height:auto;width:100%}.recs-vertical-slider-btn{cursor:pointer;display:inline-block;vertical-align:top;width:30px;height:30px;background-color:#fff;border-width:0;border-radius:3px;box-shadow:-3px 0 6px -3px rgba(68,88,112,.3)}.recs-vertical-slider-btn:disabled{opacity:.5;cursor:not-allowed}.recs-vertical-slider-btn.rex-vertical-slider--top img{transform:rotate(90deg)}.recs-vertical-slider-btn.rex-vertical-slider--bottom img{transform:rotate(90deg)}.recs-vertical-slider__content{text-overflow:ellipsis;overflow:hidden;white-space:nowrap;text-align:center}.recs-vertical-slider__content{margin:0;padding:5px 0}.unbxd-recs-slider{position:relative}.recs-slider-btn{background-color:#fff;border-width:0;border-radius:3px;box-shadow:-3px 0 6px -3px rgba(68,88,112,.3);cursor:pointer;height:65px;padding:0;position:absolute;top:50%;transform:translateY(-50%);width:30px}.recs-slider-btn:disabled{cursor:not-allowed;opacity:.5}.recs-slider-btn img{padding:16px 5px}.rex-slider--prev{left:0}.rex-slider--next{right:0}.recs-slider__content{margin-top:5px;margin-bottom:0;width:inherit;overflow:hidden;font-family:OpenSans;font-size:14px;font-weight:600;font-stretch:normal;font-style:normal;text-align:center;color:#445870}.content--ratings .recs-star{height:15px;width:15px}.content--ratings .recs-star img{height:inherit;width:inherit;margin:0}';
...
export var configuration = {
    "targetDOMElementId": "recommendations",
    "heading":{
...
var context = {
    widgets:{
        widget1:"recommendations",
        widget2:"recommendations2",
    },
    userInfo:{
        userId:123,
        siteKey:'abc',
